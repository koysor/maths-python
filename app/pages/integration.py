...
st.write("Add C which is the constant of integration.  When we differentiate, any constant terms will disapper.  Therefore many functions have the same derivative.")
st.write("When we integrate, we need to add a constant term to the function to account for this.")
...
with col1:
    ...
    st.write("Integrate to obtain the integral.  The limits are displayed next to the square brackets.")
...
with col1:
    st.write("This version of the **Chain Rule** can be used to find the gradient of a curve which is defined by **parametric equations**.")
...
with col1:
    st.write("Numerical integration is used to calculate an approximate value of an integral of a function by using making discreate.")

with col2:
    st.video("https://www.youtube.com/watch?v=ba6j_9f_5e4&list=PLHnDkwDE03A88Tj3mrg_LRpUWqyVipHkM&index=118")