...
st.write("Linear algebra is the branch of mathematics concerning linear equations, linear functions, and their representations through matrices and vector spaces.")

st.markdown("### Vectors")
st.write("A vector is a quantity that has both magnitude and direction. It can be represented as an ordered list of numbers, which are called components.")
...
st.write("A matrix can be represented as a rectangular array of numbers, symbols, or expressions, arranged in rows and columns.")
latex_code = r"""
M =
\begin{bmatrix}
a_{11} & a_{12} \\
